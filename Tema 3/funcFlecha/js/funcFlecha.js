...
let saludarExterno = usuario1.saludarTradicional;
saludarExterno.call(usuario1); // "Hola, mi nombre es undefined." (en modo no estricto)

let saludarFlechaExterno = usuario1.saludarFlecha;
saludarFlechaExterno.apply(usuario1); // "Hola, mi nombre es undefined."
